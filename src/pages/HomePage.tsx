...
import freeShippingBanner from "../assets/freeShipping_banner.jpg";
import laptopBanner from "../assets/laptop_banner.jpg";
...
export function HomePage() {
  ...
  return (
    <section className="home-page flex-col">
      ...
      <img className="banner b-radius-4" src={freeShippingBanner} alt="Free shipping banner" />
      {popular.length > 0 && <ProductSlider products={popular} title="Popular" />}
      <BannerLink banner={laptopBanner} link="category/laptops" promoName="Laptop" />
    </section>
  );
}
